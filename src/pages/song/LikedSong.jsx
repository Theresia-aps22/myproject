    ...
    <ThemeProvider theme={darkTheme}>
      ...
      <div className="liked-song-container">
        <Box className="liked-song-header">
          ...
          <Typography variant="h4" className="liked-song-title"><FavoriteBorderIcon/> Liked Songs</Typography>
        </Box>
        <Box className="song-card">
          ...
          <Box className="song-details">
            <Typography variant="body1" fontWeight="bold" className="song-title" noWrap>
